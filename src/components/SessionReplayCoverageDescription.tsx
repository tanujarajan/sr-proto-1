...
export function SessionReplayCoverageDescription({
  isCrossProjectView
}: SessionReplayCoverageDescriptionProps) {
  return <div className="space-y-2 text-sm text-muted-foreground leading-relaxed">
      {isCrossProjectView ? <>
          <p>
